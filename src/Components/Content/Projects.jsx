...
function Projects() {
  ...
  return (
    <div id='Projects' className='bg-white text-black dark:bg-slate-900 dark:text-white p-20 flex flex-col items-center justify-center h-screen overflow-x-hidden'>
